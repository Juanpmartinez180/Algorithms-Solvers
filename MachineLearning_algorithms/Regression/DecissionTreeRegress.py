...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 26 20:39:59 2020

@author: juan
"""
#Regresion con Arboles de decision CART
...
regression = DecisionTreeRegressor( criterion="mse", random_state = 0 )
regression.fit(X,y)
...
plt.plot(X, regression.predict(X), color = 'green', label = 'Prediction')
plt.title("Modelo de regresion por Árboles de Decision")
